...
<x-app-laout-web url="{{route('posts.index')}}" name="home">
            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="text-gray-500 text-sm">
                                <span>Published on  {{$post->updated_at->toFormattedDateString()}}</span>
                                <span class="mx-2">•</span>
                                <span>{{$post->updated_at ? $post->updated_at->diffForHumans() : $post->created_at->diffForHumans()}} read</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex space-x-3">
                        ...
                        <a href="{{route("posts.edit",$post)}}" class="text-gray-500 hover:text-gray-700 flex items-center">
            ...
            <div class="border-t border-gray-200 p-6">
                <h3 class="text-xl font-bold mb-6">Comments ({{$post->comments->count()}})</h3>
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="flex-1">
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <div class="flex items-center justify-between mb-2">
                                        ...
                                        <span class="text-gray-500 text-sm">{{$comment->created_at->diffForHumans()}} ago</span>
                                    </div>
                      ...
                      {{-- {{ $comments->onEachSide(1)->links()->with(['class' => 'flex items-center justify-center gap-2 mt-6']) }} --}}
